...
输出：experiment3_final_result_B1.json, experiment3_step1_B1_taskcover.json,
      experiment3_step1_B1_cumulative_trusted_ratio.json,
      experiment3_step1_B1_std_results.json
      experiment3_step1_B1_worker_category.csv（工人类别变化）
"""
...
def run_experiment_B1(seed, worker_segments_path, task_segments_path, budget, K, R):
    ...
    OUTPUT_WORKER_OPTIONS = 'experiment3_worker_option_set_B1.json'
    OUTPUT_TASK_WEIGHTS = 'experiment3_task_weight_list_B1.json'
    OUTPUT_TASK_GRID = 'experiment3_tasks_grid_num_B1.json'
    OUTPUT_TASK_CLASS = 'experiment3_tasks_classification_B1.json'
...
def main():
    ...
    # 中间文件列表（实验结束后删除）
    intermediate_files = [
        'experiment3_worker_option_set_B1.json',
        'experiment3_task_weight_list_B1.json',
        'experiment3_tasks_grid_num_B1.json',
        'experiment3_tasks_classification_B1.json'
    ]
    ...
    temp_worker_options = 'experiment3_worker_option_set_B1.json'
    temp_task_weights = 'experiment3_task_weight_list_B1.json'
    temp_task_grid = 'experiment3_tasks_grid_num_B1.json'
    temp_task_class = 'experiment3_tasks_classification_B1.json'
    ...
    save_json(avg_coverage_records, "experiment3_step1_B1_taskcover.json")
    with open("experiment3_step1_B1_taskcover.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
    ...
    save_json(avg_cumulative_records, "experiment3_step1_B1_cumulative_trusted_ratio.json")
    with open("experiment3_step1_B1_cumulative_trusted_ratio.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
    ...
    save_json(avg_result, "experiment3_final_result_B1.json")
    ...
    save_json(std_result, "experiment3_step1_B1_std_results.json")

    # 工人类别变化 CSV
    with open("experiment3_step1_B1_worker_category.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
    ...
    print("✅ 工人类别变化曲线已保存至 experiment3_step1_B1_worker_category.csv")
