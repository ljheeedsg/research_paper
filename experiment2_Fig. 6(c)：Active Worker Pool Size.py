...
OUTPUT_PNG = "experiment2_Fig. 6(c)：Active Worker Pool Size.png"
OUTPUT_PDF = "experiment2_Fig. 6(c)：Active Worker Pool Size.pdf"
OUTPUT_CSV = "experiment2_Fig. 6(c)：Active Worker Pool Size.csv"
METRIC_KEY = "num_available_workers"
SMOOTH_WINDOW = 1
LEGEND_MODE = "manual"
LEGEND_LOC = "upper center"
LEGEND_BBOX_TO_ANCHOR = (0.41, 0.98)
LEGEND_NCOL = 2
YLIM_MODE = "manual"
YLIM = (50, 220)
YTICK_STEP = 20
...
def plot_figure():
    ...
    ax.set_xlabel("Round")
    ax.set_ylabel("Active Worker Pool Size")
    ax.set_xlim(0, 145)
    ...
    if YLIM_MODE == "manual":
        ...
        margin = max((y_max - y_min) * 0.08, 8.0)
