...
OUTPUT_PNG = "experiment2_Fig. 6(d)：Worker Participation Length.png"
OUTPUT_PDF = "experiment2_Fig. 6(d)：Worker Participation Length.pdf"
OUTPUT_CSV = "experiment2_Fig. 6(d)：Worker Participation Length.csv"
LEGEND_MODE = "manual"
