...
OUTPUT_FILE = "experiment2_图1_1_累计完成率_六条线.png"
...
def main():
    ...
    for config in SERIES_CONFIG:
        ...
        y = [float(item["cumulative_completion_rate"]) for item in rounds]
        ...
        ax.plot(
            ...
            linewidth=config.get("linewidth", 2.2),
            markersize=5.2,
    ...
    ax.set_xlabel("Round")
    ax.set_ylabel("Cumulative Completion Ratio")
