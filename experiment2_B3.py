...
输出：experiment2_final_result_B3.json, experiment2_step1_B3_taskcover.json,
      experiment2_step1_B3_cumulative_trusted_ratio.json,
      experiment2_step1_B3_std_results.json（标准差）
      experiment2_step1_B3_worker_category.csv（工人类别变化）
"""
...
def data_preparation(worker_segments_path, task_segments_path,
    ...
    save_json(lgsc_params, 'experiment2_lgsc_params_B3.json')
    print("已保存 LGSC 参数 experiment2_lgsc_params_B3.json（占位）")
...
def run_experiment_B3(seed, worker_segments_path, task_segments_path, budget, K, R,
    ...
    OUTPUT_WORKER_OPTIONS = 'experiment2_worker_option_set_B3.json'
    OUTPUT_TASK_WEIGHTS = 'experiment2_task_weight_list_B3.json'
    OUTPUT_TASK_GRID = 'experiment2_tasks_grid_num_B3.json'
    OUTPUT_TASK_CLASS = 'experiment2_tasks_classification_B3.json'
    ...
    Uc, Uu, Um, _, _, task_time_map = initialize_cmab(
        OUTPUT_WORKER_OPTIONS, OUTPUT_TASK_WEIGHTS, OUTPUT_TASK_CLASS, 'experiment2_lgsc_params_B3.json'
    )
...
def main():
    ...
    # 定义要删除的中间文件列表
    intermediate_files = [
        'experiment2_worker_option_set_B3.json',
        'experiment2_task_weight_list_B3.json',
        'experiment2_tasks_grid_num_B3.json',
        'experiment2_tasks_classification_B3.json',
        'experiment2_lgsc_params_B3.json'
    ]
    ...
    temp_worker_options = 'experiment2_worker_option_set_B3.json'
    temp_task_weights = 'experiment2_task_weight_list_B3.json'
    temp_task_grid = 'experiment2_tasks_grid_num_B3.json'
    temp_task_class = 'experiment2_tasks_classification_B3.json'
    ...
    save_json(avg_coverage_records, "experiment2_step1_B3_taskcover.json")
    with open("experiment2_step1_B3_taskcover.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
    ...
    save_json(avg_cumulative_records, "experiment2_step1_B3_cumulative_trusted_ratio.json")
    with open("experiment2_step1_B3_cumulative_trusted_ratio.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
    ...
    # 工人类别变化 CSV
    with open("experiment2_step1_B3_worker_category.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
    ...
    print("✅ 工人类别变化曲线已保存至 experiment2_step1_B3_worker_category.csv")
