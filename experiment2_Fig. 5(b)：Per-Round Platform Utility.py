...
OUTPUT_PNG = "experiment2_Fig. 5(b)：Per-Round Platform Utility.png"
OUTPUT_PDF = "experiment2_Fig. 5(b)：Per-Round Platform Utility.pdf"
OUTPUT_CSV = "experiment2_Fig. 5(b)：Per-Round Platform Utility.csv"
...
def plot_figure():
    ...
    ax.set_xlabel("Round")
    ax.set_ylabel("Per-Round Platform Utility")
    ax.set_xlim(0, 145)
