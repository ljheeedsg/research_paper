...
OUTPUT_PNG = "experiment2_Fig. 19补充：最终留存与可信池规模.png"
OUTPUT_PDF = "experiment2_Fig. 19补充：最终留存与可信池规模.pdf"
OUTPUT_CSV = "experiment2_Fig. 19补充：最终留存与可信池规模.csv"
LEGEND_MODE = "manual"
...
def main():
    ...
    for variant in VARIANT_CONFIG:
        all_runs_payload = load_all_runs(variant["path"])
        rows.append(
            {
