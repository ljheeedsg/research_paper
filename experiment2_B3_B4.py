...
METRICS_TO_PLOT = [
    {
        ...
        "title": "Experiment 2 B3-B4: Coverage Rate Comparison (Smoothed)",
        "filename": "experiment2_B3_B4_coverage_rate.png",
        "smooth_window": 7,
    },
    {
        "key": "completion_rate",
        "ylabel": "Completion Rate",
        "title": "Experiment 2 B3-B4: Completion Rate Comparison (Smoothed)",
        "filename": "experiment2_B3_B4_completion_rate.png",
        "smooth_window": 7,
    },
    {
        "key": "cumulative_coverage_rate",
        "ylabel": "Cumulative Coverage Rate",
        "title": "Experiment 2 B3-B4: Cumulative Coverage Rate Comparison",
        "filename": "experiment2_B3_B4_cumulative_coverage_rate.png",
    },
    {
        "key": "cumulative_completion_rate",
        "ylabel": "Cumulative Completion Rate",
        "title": "Experiment 2 B3-B4: Cumulative Completion Rate Comparison",
        "filename": "experiment2_B3_B4_cumulative_completion_rate.png",
    },
    {
        "key": "avg_quality",
        "ylabel": "Average Realized Quality",
        "title": "Experiment 2 B3-B4: Average Realized Quality Comparison (Smoothed)",
        "filename": "experiment2_B3_B4_avg_quality.png",
        "smooth_window": 7,
    },
    {
        "key": "cumulative_avg_quality",
        "ylabel": "Cumulative Average Quality",
        "title": "Experiment 2 B3-B4: Cumulative Average Quality Comparison",
        "filename": "experiment2_B3_B4_cumulative_avg_quality.png",
    },
    {
        "key": "platform_utility",
        "ylabel": "Platform Utility",
        "title": "Experiment 2 B3-B4: Platform Utility Comparison",
        "filename": "experiment2_B3_B4_platform_utility.png",
    },
    {
        "key": "cumulative_platform_utility",
        "ylabel": "Cumulative Platform Utility",
        "title": "Experiment 2 B3-B4: Cumulative Platform Utility Comparison",
...
def build_series():
    ...
    if not series:
        raise ValueError("No available B3/B4 experiment2 result files were found.")
