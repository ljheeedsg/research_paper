...
class Simulator:
    ...
    def run(self):
        ...
        cumulative_state = {
            ...
            "total_platform_cost_sum": 0.0,
            "net_platform_cost_sum": 0.0,
            "validation_reports_sum": 0,
            "extra_validation_reports_sum": 0,
            "reused_validation_reports_sum": 0,
        ...
        for slot_id in range(self.config["TOTAL_SLOTS"]):
            ...
            platform_result = compute_platform_utility(
                ...
                validation_cost=algorithm_update.get("validation_cost", 0.0),
            )
            ...
            round_result = {
                ...
                "total_platform_cost": platform_result["total_platform_cost"],
                "net_platform_cost": platform_result["net_platform_cost"],
                "validation_cost": platform_result["validation_cost"],
