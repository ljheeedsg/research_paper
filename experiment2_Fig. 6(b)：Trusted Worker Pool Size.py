...
OUTPUT_PNG = "experiment2_Fig. 6(b)：Trusted Worker Pool Size.png"
OUTPUT_PDF = "experiment2_Fig. 6(b)：Trusted Worker Pool Size.pdf"
OUTPUT_CSV = "experiment2_Fig. 6(b)：Trusted Worker Pool Size.csv"
METRIC_KEY = "trusted_count"
SMOOTH_WINDOW = 1
LEGEND_MODE = "manual"
LEGEND_LOC = "upper center"
LEGEND_BBOX_TO_ANCHOR = (0.40, 0.98)
LEGEND_NCOL = 2
YLIM_MODE = "manual"
YLIM = (50, 180)
...
def plot_figure():
    ...
    ax.set_xlabel("Round")
    ax.set_ylabel("Trusted Worker Pool Size")
    ax.set_xlim(0, 145)
    ax.set_xticks(range(0, 141, 20))
    if YLIM_MODE == "manual":
        ax.set_ylim(*YLIM)
        ax.set_yticks(range(YLIM[0], YLIM[1] + 1, 20))
