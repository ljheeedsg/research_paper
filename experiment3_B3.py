...
输出：experiment3_final_result_B3.json, experiment3_step1_B3_taskcover.json,
      experiment3_step1_B3_cumulative_trusted_ratio.json,
      experiment3_step1_B3_std_results.json（标准差）
      experiment3_step1_B3_worker_category.csv（工人类别变化）
"""
...
def data_preparation(worker_segments_path, task_segments_path,
    ...
    save_json(lgsc_params, 'experiment3_lgsc_params_B3.json')
    print("已保存 LGSC 参数 experiment3_lgsc_params_B3.json（占位）")
...
def run_experiment_B3(seed, worker_segments_path, task_segments_path, budget, K, R,
    ...
    OUTPUT_WORKER_OPTIONS = 'experiment3_worker_option_set_B3.json'
    OUTPUT_TASK_WEIGHTS = 'experiment3_task_weight_list_B3.json'
    OUTPUT_TASK_GRID = 'experiment3_tasks_grid_num_B3.json'
    OUTPUT_TASK_CLASS = 'experiment3_tasks_classification_B3.json'
    ...
    Uc, Uu, Um, _, _, task_time_map = initialize_cmab(
        OUTPUT_WORKER_OPTIONS, OUTPUT_TASK_WEIGHTS, OUTPUT_TASK_CLASS, 'experiment3_lgsc_params_B3.json'
    )

    task_class = load_json(OUTPUT_TASK_CLASS)
    task_grid_map = {item['task_id']: item['grid_id'] for item in load_json(OUTPUT_TASK_GRID)}

    result, coverage_curve, cumulative_curve, worker_cat = greedy_recruitment_B3(
        workers, task_covered_count, required_workers, total_learned_counts,
        Uc, Uu, Um,
...
def main():
    ...
    # 定义要删除的中间文件列表
    intermediate_files = [
        'experiment3_worker_option_set_B3.json',
        'experiment3_task_weight_list_B3.json',
        'experiment3_tasks_grid_num_B3.json',
        'experiment3_tasks_classification_B3.json',
        'experiment3_lgsc_params_B3.json'
    ]
    ...
    temp_worker_options = 'experiment3_worker_option_set_B3.json'
    temp_task_weights = 'experiment3_task_weight_list_B3.json'
    temp_task_grid = 'experiment3_tasks_grid_num_B3.json'
    temp_task_class = 'experiment3_tasks_classification_B3.json'
    ...
    for idx, seed in enumerate(seeds):
        ...
        coverage_curve, cumulative_curve, result, worker_cat = run_experiment_B3(
    ...
    save_json(avg_coverage_records, "experiment3_step1_B3_taskcover.json")
    with open("experiment3_step1_B3_taskcover.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
    ...
    save_json(avg_cumulative_records, "experiment3_step1_B3_cumulative_trusted_ratio.json")
    with open("experiment3_step1_B3_cumulative_trusted_ratio.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
    ...
    save_json(avg_result, "experiment3_final_result_B3.json")
    ...
    save_json(std_result, "experiment3_step1_B3_std_results.json")

    # 工人类别变化 CSV
    with open("experiment3_step1_B3_worker_category.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
    ...
    print("✅ 工人类别变化曲线已保存至 experiment3_step1_B3_worker_category.csv")
