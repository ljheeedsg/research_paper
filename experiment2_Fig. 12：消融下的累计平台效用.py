...
OUTPUT_PNG = "experiment2_Fig. 12：消融下的累计平台效用.png"
OUTPUT_PDF = "experiment2_Fig. 12：消融下的累计平台效用.pdf"
OUTPUT_CSV = "experiment2_Fig. 12：消融下的累计平台效用.csv"
METRIC_KEY = "cumulative_platform_utility"
LEGEND_MODE = "manual"
LEGEND_LOC = "upper left"
LEGEND_BBOX_TO_ANCHOR = (0.03, 0.98)
LEGEND_NCOL = 1
YLIM_MODE = "auto"
YLIM = None
...
def plot_figure():
    ...
    if YLIM_MODE == "manual" and YLIM is not None:
        ...
        margin = max((y_max - y_min) * 0.08, 100.0)
